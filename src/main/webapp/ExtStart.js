...
Ext.onReady(function() {
    ...
    function processResult(opt){
        if(opt == 'no'){
            alert('Ha apretado No');
        }
        if(opt == 'yes'){
            alert('Ha apretado Yes');
        }
    }
    /*Ext.Msg.show({
        title:'Consulta',
        msg: 'cualquier pregunta?',
...
//    Ext.MessageBox.confirm('Modificar', 'Esta seguro de modificar la contraseña?', processResult);
    ...
    myDiv.setOpacity(.75);   // Vuelve el elemento parcialmente transparente
    ...
    var paragraphClicked = function(e) {
        //        var obj = e.target;
        //        Ext.get(obj).highlight();
        //        alert("obj = " + obj.innerHTML);
        //        alert("Has hecho click en un parrafo");

        var paragraph = Ext.get(e.target);
        paragraph.highlight( );

        Ext.MessageBox.show({
            title: 'P&aacute;rrafo cliqueado',
            msg: paragraph.dom.innerHTML,
            width: 400,
            buttons: Ext.MessageBox.OK,
            animEl: paragraph
        });
    }; // fin paragraphClicked

    Ext.select('p').on('click', paragraphClicked);
    //    Ext.select('p').on('mouseover', paragraphClicked);
                ...
                items: [
                    {
                        ...
                        handler: function(grid, rowIndex, colIndex) {
                            ...
                            alert("Sell " + rec.get('company') + " i: " + rowIndex);
                        }
                    }, {
